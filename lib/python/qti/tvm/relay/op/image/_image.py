...
# [QTI Change]
from .image import resize1d
from .image import resize3d
# [End QTI Change]
...
### [QTI Change]
@reg.register_convert_op_layout("image.resize3d")
def convert_image_resize3d(attrs, inputs, tinfos, desired_layouts):
    """Convert Layout pass registration for image resize3d op.
    ...
    assert desired_layout != "default", "Layout cannot be default"
    new_attrs["layout"] = desired_layout
    return resize3d(*inputs, **new_attrs)
### [End QTI Change]
