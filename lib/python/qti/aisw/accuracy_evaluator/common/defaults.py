...
DEFAULTS_VALUES = {
    ...
    "qacc": {
        ...
        "default_inference_schemas": {
            ...
            # Setting default inference schema to run int8 precision model on lahaina device (aarch64-android architecture) using QNN engine
            "dspv68": {
                "inference_schema": {
                    "backend": "dspv68",
                    "converter_params": {
            ...
            # Setting default inference schema to run int8 precision model on pakala device (aarch64-android architecture) using QNN engine
            "dspv79": {
                "inference_schema": {
                    "backend": "dspv79",
                    "converter_params": {
