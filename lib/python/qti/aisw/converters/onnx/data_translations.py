...
class OnnxResizeTranslation(OnnxTranslationBase):
    ...
    def extract_parameters(self, src_op, converter_context):
        ...
        if 'antialias' in params and params.antialias == 1:
            raise ValueError("Unsupported value of {} provided as antialias attribute for Resize Op {}."
                             "Only 0 (default) is supported.".format(1, src_op.name))
