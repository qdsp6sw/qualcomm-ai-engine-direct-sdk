...
MODEL_TENSOR_NAMES: dict[MODEL_ARCH, dict[MODEL_TENSOR, str]] = {
    ...
    MODEL_ARCH.GPT2: {
        MODEL_TENSOR.TOKEN_EMBD   : "token_embd",
        MODEL_TENSOR.POS_EMBD     : "token_embd_pos",
        MODEL_TENSOR.OUTPUT       : "output",
        MODEL_TENSOR.OUTPUT_NORM  : "output_norm",
        MODEL_TENSOR.ATTN_MASK    : "blk.{bid}.attn_mask",
        MODEL_TENSOR.ATTN_Q       : "blk.{bid}.attn_q",
        MODEL_TENSOR.ATTN_K       : "blk.{bid}.attn_k",
        MODEL_TENSOR.ATTN_V       : "blk.{bid}.attn_v",
        MODEL_TENSOR.ATTN_OUT     : "blk.{bid}.attn_output",
...
class TensorNameMap:
    mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.TOKEN_EMBD: (
            ...
            "transformer.wte",             # gpt2 mpt qwen
            "wte",                         # gpt2
            "transformer.word_embeddings", # falcon
            "model.embed_tokens",          # llama-hf qwen2
        ...
        # Output
        MODEL_TENSOR.OUTPUT: (
            "embed_out", # gptneox gpt2
            "lm_head",   # gpt2 mpt falcon llama-hf baichuan qwen qwen2
            "output",    # llama-pth
        ),
        ...
        MODEL_TENSOR.OUTPUT_NORM: (
            ...
            "ln_f",                      # gpt2 qwen
            "model.norm",                # llama-hf baichuan qwen2
            "norm",                      # llama-pth
        ),
    ...
    block_mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.ATTN_NORM: (
            ...
            "transformer.h.{bid}.ln_1",              # gpt2 qwen
            "h.{bid}.ln_1",                          # gpt2
            "transformer.blocks.{bid}.norm_1",       # mpt
            "transformer.h.{bid}.input_layernorm",   # falcon7b
            "transformer.h.{bid}.ln_mlp",            # falcon40b
            "model.layers.{bid}.input_layernorm",    # llama-hf qwen2
        ...
        # Attention query
        MODEL_TENSOR.ATTN_Q: (
            "model.layers.{bid}.self_attn.q_proj", # llama-hf qwen2
            "layers.{bid}.attention.wq",           # llama-pth
            "transformer.h.{bid}.attn.q_proj",     # qwen
            "h.{bid}.attn.q_proj",                 # gpt2
        ),

        # Attention key
        MODEL_TENSOR.ATTN_K: (
            "model.layers.{bid}.self_attn.k_proj", # llama-hf qwen2
            "layers.{bid}.attention.wk",           # llama-pth
            "transformer.h.{bid}.attn.k_proj",     # qwen
            "h.{bid}.attn.k_proj",                 # gpt2
        ),

        # Attention value
        MODEL_TENSOR.ATTN_V: (
            "model.layers.{bid}.self_attn.v_proj", # llama-hf qwen2
            "layers.{bid}.attention.wv",           # llama-pth
            "transformer.h.{bid}.attn.v_proj",     # qwen
            "h.{bid}.attn.v_proj",                 # gpt2
        ),

        # Attention output
        MODEL_TENSOR.ATTN_OUT: (
            "gpt_neox.layers.{bid}.attention.dense",    # gptneox
            "transformer.h.{bid}.attn.c_proj",          # gpt2 qwen
            "h.{bid}.attn.c_proj",                      # gpt2
            "transformer.blocks.{bid}.attn.out_proj",   # mpt
            "transformer.h.{bid}.self_attention.dense", # falcon
            "model.layers.{bid}.self_attn.o_proj",      # llama-hf qwen2
        ...
        MODEL_TENSOR.FFN_NORM: (
            ...
            "transformer.h.{bid}.ln_2",                       # gpt2 qwen
            "h.{bid}.ln_2",                                   # gpt2
            "transformer.blocks.{bid}.norm_2",                # mpt
            "model.layers.{bid}.post_attention_layernorm",    # llama-hf qwen2
        ...
        MODEL_TENSOR.FFN_UP: (
            ...
            "model.layers.{bid}.mlp.up_proj",          # llama-hf qwen2
            "layers.{bid}.feed_forward.w3",            # llama-pth
        ),

        # Feed-forward gate
        MODEL_TENSOR.FFN_GATE: (
            "model.layers.{bid}.mlp.gate_proj", # llama-hf qwen2
        ...
        MODEL_TENSOR.FFN_DOWN: (
            ...
            "transformer.h.{bid}.mlp.c_proj",          # gpt2 qwen
            "h.{bid}.mlp.c_proj",                      # gpt2
            "transformer.blocks.{bid}.ffn.down_proj",  # mpt
            "transformer.h.{bid}.mlp.dense_4h_to_h",   # falcon
            "model.layers.{bid}.mlp.down_proj",        # llama-hf qwen2
...
class GGUFWriter:
    ...
    def __init__(self, path: os.PathLike[str] | str, arch: str | None = None, use_temp_file = True):
