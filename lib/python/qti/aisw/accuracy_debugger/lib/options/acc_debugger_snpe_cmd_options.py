...
from qti.aisw.accuracy_debugger.lib.utils.nd_constants import Engine, Android_Architectures, X86_Architectures, \
    Windows_Architectures, Architecture_Target_Types
...
class AccDebuggerSNPECmdOptions(CmdOptions):
    ...
    def initialize(self):
        ...
        optional.add_argument(
            '--host_device', type=str, required=False, default='x86', choices=['x86'],
        ...
        optional.add_argument(
            '--tensor_mapping', type=str, default=None,
