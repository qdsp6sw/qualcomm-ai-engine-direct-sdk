...
class MainCmdOptions(CmdOptions):
    ...
    def initialize(self):
        self.parser = argparse.ArgumentParser(
            ...
            "Script for using Framework Diagnosis, Inference Engine, Verification, Compare Encodings, Tensor Inspection and QuantChecker features.",
    ...
    def verify_update_parsed_args(self, parsed_args):
        ...
        component_args_list = [
            ...
            parsed_args.binary_snooping
        ]
        if parsed_args.snooping:
