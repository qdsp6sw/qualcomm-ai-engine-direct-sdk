...
from qti.aisw.accuracy_debugger.lib.utils.nd_path_utility import retrieveQairtSdkDir


class QAIRTEnvironment(Environment):
    ...
    def __init__(self, engine, host_device, output_directory, engine_path, logger) -> None:
        ...
        if engine_path is None:
            self.engine_path = retrieveQairtSdkDir(self._logger)
        else:
