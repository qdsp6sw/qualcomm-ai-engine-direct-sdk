...
@inference_engine_repository.register(cls_type=ComponentType.converter, framework=Framework.pytorch,
                                      engine=Engine.QNN, engine_version="0.5.0.11262")
class QNNPytorchConverter(QNNConverter):

    def __init__(self, context):
        super(QNNPytorchConverter, self).__init__(context)
